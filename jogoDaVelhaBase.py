...
def jogadaMaquina(tabuleiro, jogada):
    ...
    if jogada == 1:
        ...
        if tabuleiro["B"][0] == "" and (tabuleiro["A"][0] == "X" and tabuleiro["C"][0] == "X"):            
            tabuleiro["B"][0] = "X"
        elif tabuleiro["A"][1] == "" and (tabuleiro["A"][0] == "X" and tabuleiro["A"][2] == "X"):
            tabuleiro["A"][1] = "X"
        #diagonais
        elif tabuleiro["A"][2] == "" and (tabuleiro["C"][0] == "O" and tabuleiro["B"][1] == "O"):
            tabuleiro["A"][2] = "X"
        elif tabuleiro["C"][0] == "" and (tabuleiro["A"][2] == "O" and tabuleiro["B"][1] == "O"):
            tabuleiro["C"][0] = "X"

        # # Centro
        elif tabuleiro["A"][1] == "" and (tabuleiro["B"][1] == "O" and tabuleiro["C"][1] == "O"):
             tabuleiro["A"][1] = "X"
        elif tabuleiro["B"][0] == "" and (tabuleiro["B"][1] == "O" and tabuleiro["B"][2] == "O"):
            tabuleiro["B"][0] = "X"
        elif tabuleiro["C"][1] == "" and (tabuleiro["B"][1] == "O" and tabuleiro["A"][1] == "O"):
            tabuleiro["C"][1] = "X"
        
        
        elif (tabuleiro["A"][1] == "O" or tabuleiro["A"][2] == "O") and tabuleiro["B"][0] == "O":
            tabuleiro["C"][2] = "X"

        elif (tabuleiro["C"][2] == "O" or tabuleiro["C"][1] == "O") and tabuleiro["B"][0] == "O":
            tabuleiro["A"][2] = "X"

        elif (tabuleiro["B"][0] == "O") and (tabuleiro["B"][2] == "O"):
            tabuleiro["B"][1] = "X"
        ...
        if tabuleiro["C"][1] == "" and (tabuleiro["C"][0] == "X" and tabuleiro["C"][2] == "X"):
            tabuleiro["C"][1] = "X"

        elif tabuleiro["A"][1] == "" and (tabuleiro["A"][0] == "X" and tabuleiro["A"][2] == "X"):
            tabuleiro["A"][1] = "X"

        elif tabuleiro["B"][2] == "" and (tabuleiro["A"][2] == "X" and tabuleiro["C"][2] == "X"):
            tabuleiro["B"][2] = "X"
        ...
        elif tabuleiro["A"][2] == "" and (tabuleiro["B"][1] == "O" and tabuleiro["C"][0] == "O"):
            tabuleiro["A"][2] = "X"      


    
        elif (tabuleiro["C"][1] == "O") or (tabuleiro["A"][1] == "O"):
            tabuleiro["B"][1] = "X"
        ...
        if tabuleiro["B"][2] == "" and (tabuleiro["B"][0] == "O" and tabuleiro["B"][1] == "O"):
            tabuleiro["B"][2] = "X"
